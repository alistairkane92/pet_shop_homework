...
class TestPetShop < MiniTest::Test
  ...
  def test_sell_pet_to_customer__pet_found
    ...
    #determines which customer is trying to buy
    customer = @customers[0]

    #finds the pet in the pet shop array
    pet = find_pet_by_name(@pet_shop,"Arthur")

    #should increment the length of the customer's pet's array by 1
    #should transfer the hash of the pet to the customer's pet hash
